...
class Peak_Exception extends Exception
{
	...
	//const ERR_APP_MOD_NOT_SPECIFIED         = 'Application: module not specified.';  //@deprecated
	const ERR_APP_CTRL_NOT_FOUND            = 'Application: controller %1$s not found.';
	//const ERR_APP_LOGIN_CTRL_NOT_FOUND      = 'Application: controller loginController not found.';  //@deprecated
	...
	//const ERR_VIEW_LAYOUT_NOT_FOUND         = 'View: layout template file %1$s not found.'; //@deprecated
